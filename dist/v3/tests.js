...
mocha.setup("bdd");
chai.should();
var SPScript = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../dist/v3/spscript\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
__webpack_require__(42).run(SPScript);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(39), __webpack_require__(2)))
...
exports.run = function (SPScript, ctx) {
	...
	if (!isServer) {
		__webpack_require__(71).run(SPScript);
	...
	__webpack_require__(77).run(SPScript.utils);
};
...
exports.AssertionError = __webpack_require__(44);
...
var assertion = __webpack_require__(66);
...
var expect = __webpack_require__(68);
exports.use(expect);
...
var should = __webpack_require__(69);
exports.use(should);
...
exports.getPathValue = __webpack_require__(59);
...
var permissionsTests = __webpack_require__(13);
var should = __webpack_require__(1).should();
