...
},{"./filesystem":10,"./list":11,"./profiles":13,"./search":16,"./utils":17,"./web":18,"object-assign":4}],8:[function(require,module,exports){
(function (global){
...
},{"./spscript":9,"jquery":3}],9:[function(require,module,exports){
(function (global){
var SPScript = {};
...
},{"../queryString":14,"../restDao":15,"../utils":17,"droopy-templating":1}],10:[function(require,module,exports){
var utils = require("./utils");
...
module.exports = List;
},{"./permissions":12,"./utils":17,"object-assign":4}],12:[function(require,module,exports){
var utils = require("./utils");
...
},{"./ajax":6,"./baseDao":7,"object-assign":4}],16:[function(require,module,exports){
...
Search.prototype.query = function(queryText, queryOptions) {
	...
	return self._dao.get(url).then(utils.validateODataV2).then(function(queryResult) {
		if (queryResult) {
			return new SearchResults(queryResult);
		}
...
},{"./queryString":14}],17:[function(require,module,exports){
...
module.exports = Web;
},{"./permissions":12,"./utils":17,"object-assign":4}]},{},[8])