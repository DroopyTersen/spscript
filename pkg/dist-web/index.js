...
class Search {
  ...
  sites() {
    ...
    let urlScope = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
...
var getAppOnlyToken = function getAppOnlyToken(url, clientId, clientSecret) {
  var urlParts = parse$1(url);
  return getRealm(url).then(authParams => {
    ...
    var bodyStr = stringify(postBody);
    var opts = {
      method: "POST",
      body: bodyStr,
      headers: {
...
var registerField = function registerField(field, renderer) {
  let opts = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
...
var registerDisplayField = function registerDisplayField(fieldComponent) {
...
var registerFormField = function registerFormField(fieldComponent) {
  let opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
